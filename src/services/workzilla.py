...
class WorkZillaParserService:
    ...
    async def _parse_and_send(self) -> None:
        async with self.lock:
            ...
            if not channels:
                log.info("Нет настроенных каналов для Work-Zilla.")
                return
                ...
                try:
                    ...
                    for channel in channels:
                        ...
                        for vacancy in all_vacancies:
                            if self._filter_vacancy(vacancy, channel):
    ...
    def _filter_vacancy(self, vacancy: Dict[str, Any], channel_settings: dict) -> bool:
